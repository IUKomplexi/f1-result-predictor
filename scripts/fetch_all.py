"""CLI shim for the fetch job; the shared logic lives in ``f1data.fetch``.

Usage::

    python scripts/fetch_all.py [--start 2010] [--end 2026] [--refresh] [--sleep 0.2]
...
:func:`f1data.fetch.run` as an async job.
"""
